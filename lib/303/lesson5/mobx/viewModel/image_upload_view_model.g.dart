...
mixin _$ImageUploadViewModel on _ImageUploadViewModelBase, Store {
  ...
  void chanceLoading() {
    final _$actionInfo = _$_ImageUploadViewModelBaseActionController
        .startAction(name: '_ImageUploadViewModelBase.chanceLoading');
    try {
      return super.chanceLoading();
    } finally {
  ...
  void updateImageUrl(ImageUploadResponse? response) {
    final _$actionInfo = _$_ImageUploadViewModelBaseActionController
        .startAction(name: '_ImageUploadViewModelBase.updateImageUrl');
    try {
      return super.updateImageUrl(response);
    } finally {
      _$_ImageUploadViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
